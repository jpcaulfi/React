        ...
        <body>
            ...
            <section className="portfolio-nav">
                <div className="projects">
                    ...
                    <div className="project">
                        <Link to="/page6" className="project-link-clicked">
                            <img alt="" className="project-img-clicked" src="jupiter.png"></img>
                        </Link>
            ...
            <section className="howitsmade">
                <h2 className="tools-title">Jupiter Site <strong>built using the following:</strong></h2>
                <div className="tools">
                    <div className="tool">
                    ...
                    <div className="tool">
                        <img alt="" className="tool-img" src="fastio.png"></img>
                        <p className="tool-title">Fast.io</p>
                    </div>
                </div>
            </section>
        </body>
