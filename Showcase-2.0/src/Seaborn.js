        ...
        <body>
            ...
            <section className="portfolio-nav">
                <div className="projects">
                    ...
                    <div className="project">
                        <Link to="/page3" className="project-link-clicked">
                            <img alt="" className="project-img-clicked" src="nyse.jpg"></img>
                        </Link>
            ...
            <section className="howitsmade">
                <h2 className="tools-title">Seaborn <strong>built using the following:</strong></h2>
                <div className="tools">
                    <div className="tool">
                    ...
                    <div className="tool">
                        <img alt="" className="tool-img" src="rapidapi.png"></img>
                        <p className="tool-title">RapidAPI</p>
                    </div>
                    <div className="tool">
                        <img alt="" className="tool-img" src="discord.jpg"></img>
                        <p className="tool-title">Discord</p>
