        ...
        <body>
            ...
            <section className="portfolio-nav">
                <div className="projects">
                    ...
                    <div className="project">
                        <Link to="/page4" className="project-link-clicked">
                            <img alt="" className="project-img-clicked" src="coffee.png"></img>
                        </Link>
            ...
            <section className="howitsmade">
                <h2 className="tools-title">Herald <strong>built using the following:</strong></h2>
                <div className="tools">
                    <div className="tool">
                    ...
                    <div className="tool">
                        <img alt="" className="tool-img" src="javascript.png"></img>
                        <p className="tool-title">JavaScript</p>
                    </div>
                    <div className="tool">
