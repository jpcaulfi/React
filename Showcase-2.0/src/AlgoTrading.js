    ...
    return (
        <body>
            ...
            <section className="portfolio-nav">
                <div className="projects">
                    <div className="project">
                        <Link to="/page2" className="project-link">
                            <img alt="" className="project-img" src="amazon.jpg"></img>
                        </Link>
                    ...
                    <div className="project">
                        <Link to="/page5" className="project-link-clicked">
                            <img alt="" className="project-img-clicked" src="candles.jpg"></img>
                        </Link>
            ...
            <section className="howitsmade">
                <h2 className="tools-title">Algorithm Trading Bots <strong>built using the following:</strong></h2>
                <div className="tools">
                    <div className="tool">
                        <img alt="" className="tool-img" src="python.jpg"></img>
                        <p className="tool-title">Python</p>
                    </div> 
                    <div className="tool">
                        <img alt="" className="tool-img" src="spark.jpg"></img>
                        <p className="tool-title">Apache Spark</p>
                    </div>
                    <div className="tool">
                        <img alt="" className="tool-img" src="mt5.png"></img>
                        <p className="tool-title">MetaTrader 5</p>
                        <p className="tool-title">API</p>
                    </div>     
                    <div className="tool">
                        <img alt="" className="tool-img" src="mw.png"></img>
                        <p className="tool-title">MarketWatch</p>
                        <p className="tool-title">API</p>
                    </div>                        
                </div>
            </section>
